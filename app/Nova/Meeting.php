...
use Masalitina\GoogleMap\GoogleMap;
...
class Meeting extends Resource
{
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            Select::make('Country')
                ->options(array_column(Country::all()->toArray(),'name'))
                ->sortable()
                ->rules('required'),
            ...
            GoogleMap::make('Address')->resolveUsing(
                function () {
                    return ['latitude' => $this->model()->latitude, 'longitude' => $this->model()->longitude];
                }
